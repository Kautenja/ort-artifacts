...
BUILD_TARGETS = [
    ...
    BuildTarget(
        ...
        args="--static --android --android_api 24 --android_abi arm64-v8a --xnnpack --nnapi -N",
        runs_on="ubuntu-22.04",
        providers=("xnnpack", "nnapi"),
    ),
    BuildTarget(
        target="android-armeabi-v7a-static",
        args="--static --android --android_api 24 --android_abi armeabi-v7a --xnnpack --nnapi -N",
        runs_on="ubuntu-22.04",
        providers=("xnnpack", "nnapi"),
    ),
    BuildTarget(
        target="android-x86_64-static",
        args="--static --android --android_api 24 --android_abi x86_64 --xnnpack --nnapi -N",
        runs_on="ubuntu-22.04",
        providers=("xnnpack", "nnapi"),
    ),
    BuildTarget(
        target="android-x86-static",
        args="--static --android --android_api 24 --android_abi x86 --xnnpack --nnapi -N",
        runs_on="ubuntu-22.04",
        providers=("xnnpack", "nnapi"),
    ),
]
